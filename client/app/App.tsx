    ...
    <div className="min-h-screen bg-background" style={{ fontFamily: 'var(--font-body)' }}>
      ...
      <main className="container mx-auto px-4 py-12 md:px-6">
        ...
        >
          ...
          <h1 
            className="mb-4 text-5xl md:text-6xl lg:text-7xl text-foreground"
          ...
          <p className="mx-auto max-w-2xl text-xl text-muted-foreground mb-8">
            Upload any research paper and get an instant, student-friendly breakdown with summaries, key concepts, and interactive quizzes.
          </p>
        </motion.div>
        ...
        {!result && !isProcessing && (
          ...
          >
            <h2 
              className="mb-12 text-center text-3xl text-foreground"
              style={{ fontFamily: 'var(--font-heading)' }}
            >
              How It Works
            </h2>
            ...
            <div className="grid gap-8 md:grid-cols-3">
              ...
              >
                ...
                <h3 className="mb-3 text-xl text-foreground" style={{ fontFamily: 'var(--font-heading)' }}>
                  1. Upload PDF
                </h3>
            ...
            >
              <h3 className="mb-6 text-center text-2xl text-foreground" style={{ fontFamily: 'var(--font-heading)' }}>
      ...
      <footer className="border-t border-border py-8 text-center text-sm text-muted-foreground">
        <p>
          Built for university students to make research papers accessible and engaging.
        </p>
      </footer>
    </div>
  );
